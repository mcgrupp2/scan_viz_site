...
).properties(title="Model Diagnosed",width=800).interactive()
...
).properties(title="Higher Performance Tests",width=800).interactive()
...
).properties(title="Rapid Diagnostic Tests",width=800).interactive()
